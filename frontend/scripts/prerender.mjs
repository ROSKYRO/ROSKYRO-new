  ...
  const staticPages = [
    {
      ...
      description:
        "ROSKYRO is a Healthcare Concierge — background-verified, trained care partners for elder care, hospital assistance and urgent support. Book in minutes, pay after the visit.",
      jsonLd: {
        ...
        description:
          "ROSKYRO is a Healthcare Concierge — background-verified, trained care partners for elder care, hospital assistance, urgent support, medical travel and diagnostics.",
      },
    },
    {
      urlPath: "/blog",
    ...
    },
    {
      ...
      title: "How ROSKYRO Works | Healthcare Concierge, Verified Care, On Call",
      description:
