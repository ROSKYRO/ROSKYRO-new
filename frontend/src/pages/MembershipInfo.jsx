...
const FREQUENT_CARE_NOTE =
  "If you need Frequent Care — dialysis, regular physiotherapy, recurring hospital visits, BP/diabetes check-ups, and similar recurring needs — this is handled through our standard hourly Relationship Officer booking system. This applies across all three plans (Care, Family, and NRI Care).";
...
const SEPARATE = [
  ...
  "Frequent Care needs (dialysis, physiotherapy, recurring hospital visits, BP/diabetes check-ups, etc.) — via the hourly booking system",
      ...
      <div className="max-w-4xl mx-auto px-5">
        ...
        <section className="py-11">
          ...
          <div className="bg-mist rounded-2xl px-5 py-4.5 text-[13.5px] text-ink border-l-4 border-violet mt-5">
            ...
            a regular booking. The free quota resets every month and does not carry forward.
          </div>
          ...
          <div className="bg-mist rounded-2xl px-5 py-4.5 text-[13.5px] text-ink border-l-4 border-ink/30 mt-4">
            <b className="text-ink">Frequent Care needs:</b>
            <br />
            {FREQUENT_CARE_NOTE}
          </div>
        </section>
