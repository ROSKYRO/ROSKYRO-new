const STEPS = [
  { title: "Choose a service", desc: "24x7 Urgent Support, Hospital Concierge, Elderly Care Concierge, Medical Travel Concierge, Diagnostic Concierge, or Post-Discharge Concierge — pick what you need and when." },
