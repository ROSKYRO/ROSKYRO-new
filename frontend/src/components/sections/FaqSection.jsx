...
const FAQS = [
  ...
  { q: "What does it cost?", a: "ROSKYRO Relationship Officer (pay-per-visit): 24×7 Urgent Support ₹269/hr, Hospital Concierge ₹249/hr, Elderly Care Concierge ₹229/hr, Medical Travel Concierge ₹349/hr, Diagnostic Concierge ₹179/hr, Post-Discharge Concierge ₹209/hr — plus 18% GST shown separately on your bill. ROSKYRO Concierge (annual membership): Care ₹24,999/year, Family ₹59,999/year, NRI Care ₹99,999/year — each with yearly doctor consultation, ambulance and medical-travel allowances plus free monthly Relationship Officer visits. Frequent Care needs (dialysis, physiotherapy, recurring hospital visits, BP/diabetes check-ups, etc.) are handled via the hourly booking system across all plans. No other hidden charges either way." },
  { q: "What's the difference between ROSKYRO Relationship Officer and ROSKYRO Concierge?", a: "Relationship Officer is pay-per-visit — hire a verified Partner by the hour whenever you need hands-on help. Concierge is an annual membership where a dedicated concierge coordinates your ongoing healthcare — appointments, hospital and diagnostic coordination, follow-ups and family updates. Doctor consultations, lab/imaging, medicines and hospital bills are always billed separately at their own rates, whichever you choose." },
  ...
  { q: "Which areas do you cover?", a: "We're starting in Ambikapur — our first Hive. Once we've made care reliable here, we'll expand city by city across Chhattisgarh and beyond. Message us to check availability in your area." },
