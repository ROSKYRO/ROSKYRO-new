...
const CLAUSES = [
  ...
  { icon: "🩺", title: "ROSKYRO Concierge membership — health information", body: "Membership coordination (appointments, documents, care history) may involve health-related information. We access it only for the immediate coordination task and do not store medical documents, reports, or their contents permanently in our database. Documents are shared directly with your concierge over WhatsApp and are not uploaded to or described in our systems. Care-request notes should stick to coordination detail (e.g. reason for a visit) rather than diagnosis or report content." },
];
