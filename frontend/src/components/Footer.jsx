  ...
  return (
    <footer className="bg-ink text-parchment/80 mt-24">
      <div className="max-w-6xl mx-auto px-5 py-14 grid grid-cols-1 md:grid-cols-4 gap-10">
        <div>
          <div className="flex items-center gap-2 mb-3"><img src="/brand/logo.png" alt="ROSKYRO — Healthcare Concierge" className="w-8 h-8 object-contain" /><span className="font-display text-xl text-parchment">ROSKYRO<span className="block text-[11px] font-sans font-medium tracking-wide text-parchment/50 uppercase">Healthcare Concierge</span></span></div>
        ...
        <div><div className="text-sm font-semibold text-parchment mb-3">Services</div><ul className="space-y-2 text-sm text-parchment/60"><li><Link to="/blog/urgent-support">24x7 Urgent Support</Link></li><li><Link to="/blog/hospital-concierge">Hospital Concierge</Link></li><li><Link to="/blog/elderly-care-concierge">Elderly Care Concierge</Link></li><li><Link to="/blog/medical-travel-concierge">Medical Travel Concierge</Link></li><li><Link to="/blog/diagnostic-concierge">Diagnostic Concierge</Link></li><li><Link to="/blog/post-discharge-concierge">Post-Discharge Concierge</Link></li></ul></div>
        <div><div className="text-sm font-semibold text-parchment mb-3">Company</div><ul className="space-y-2 text-sm text-parchment/60"><li><a href="/#story">About ROSKYRO</a></li><li><a href="/#how">How It Works</a></li><li><Link to="/blog">Blog</Link></li><li><a href="/#trust">Safety & Trust</a></li><li><a href="/#join">Become a Partner</a></li><li><a href="/#faq">FAQs</a></li><li><a href="/#complaint">Complaints & Feedback</a></li><li><Link to="/hospital/login">Hospital Console</Link></li></ul></div>
