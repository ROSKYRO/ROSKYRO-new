...
// Canonical brand positioning — every page title, meta tag, and on-page
// header/footer should carry this so the brand always reads as
// "ROSKYRO — Healthcare Concierge" whenever the site or a shared link opens.
export const BRAND_TAGLINE = "Healthcare Concierge";
...
export const PILOT_CITY = "Ambikapur";
